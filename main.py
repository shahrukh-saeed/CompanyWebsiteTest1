...
def product_page():
  ...
  print(DATA)
  return render_template("product-page.html", data=DATA)


@app.route("/browse-products/product-page/reciept", methods=['post'])
def reciept():
  DATA = request.form.to_dict()
  ORDERS.append({
  ...
  print(ORDERS)
  return render_template("reciept.html", data=DATA)
